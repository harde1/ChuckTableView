...
@interface ViewController ()<SmartDelegate>
@property(nonatomic,strong)SmartTableView * sd;
...
-(void)viewDidAppear:(BOOL)animated{
    ...
    _sd = [[SmartTableView alloc]initWithFrame:self.view.bounds
                                         style:0
                                 defaultHeight:100
                                    vcDelegate:self
    ...
    [_sd addModel:@"我是SmartCell，在s0,r0" cellClass:SmartCell.class];
    [_sd addModel:@"我是SmartCell，在s0,r1" cellClass:SmartCell.class];
    [_sd addModels:@[@"我是删除模式,s0,r2",@"我是删除模式,s0,r3"] cellClass:SmartCell.class editStyle:UITableViewCellEditingStyleDelete];
    [_sd addModel:@"haha2,s0,r4" cellClass:SmartCell.class];
    [_sd addModels:@[@"我是删除模式,s3,r0",@"我是删除模式,s3,r1"] cellClass:SmartCell.class section:3 editStyle:UITableViewCellEditingStyleDelete];
    [_sd addModel:@"我是SmartCell，在s3,r2" cellClass:SmartCell.class section:3];
    [_sd addModel:@"我是SmartCell，在s0,r5" cellClass:SmartCell.class];
    [_sd addModels:@[@"我在预设置里面,s2,r0",@"因为我是UItableViewCell,s2,r1"] section:2];
    [_sd addModels:@[@"我是SmartCell，在s5,r0",@"我是SmartCell，在s5,r1"] cellClass:SmartCell.class section:5];
    [_sd addModels:@[@"我是SmartCell，在s1,r0",@"我是SmartCell，在s1,r1"] cellClass:SmartCell.class section:1];
    [_sd addModels:@[@"我是删除模式,s1,r2",@"我是删除模式,s1,r3"] cellClass:SmartCell.class section:1 editStyle:UITableViewCellEditingStyleDelete];
    [_sd addModel:@"我是SmartCell，在s0,r6" cellClass:SmartCell.class];
    [_sd addModel:@"我是SmartCell，在s10,r0" cellClass:SmartCell.class section:10];
    [_sd addModels:@[@"我是SmartCell，在s9,r0",@"我是SmartCell，在s9,r1",@"我是SmartCell，在s9,r2",@"我是SmartCell，在s9,r3",@"我是SmartCell，在s9,r4"] cellClass:SmartCell.class section:9];
...
-(void)doShouCang{
    ...
    [_sd insertModel:@"我插" cellClass:XibAutpHeightCell.class indexPath:indexPath animation:UITableViewRowAnimationLeft];
