...
- (void)tableView:(ChuckTableView *)tableView vcDelegate:(id)vcDelegate didEndDisplayingCellWithModel:(id)model atIndexPath:(NSIndexPath *)indexPath;
-(void)tableView:(ChuckTableView *)tableView vcDelegate:(id)vcDelegate willDisplayCellWithModel:(id)model atIndexPath:(NSIndexPath *)indexPath;
...
- (void)collectionView:(ChuckCollectionView *)collectionView vcDelegate:(id)vcDelegate didEndDisplayingCellWithModel:(id)model atIndexPath:(NSIndexPath *)indexPath;
-(void)collectionView:(ChuckCollectionView *)collectionView vcDelegate:(id)vcDelegate willDisplayCellWithModel:(id)model atIndexPath:(NSIndexPath *)indexPath;
