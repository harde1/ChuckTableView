#
#  Be sure to run `pod spec lint ChuckTableView.podspec' to ensure this is a
...
5、cell与tableView解耦，与UIViewController解耦
  ...
  # s.authors            = { "harde1" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/harde1"
  ...
  s.source_files  = "ChuckTableView", "ChuckTableView/*.{h,m}"
